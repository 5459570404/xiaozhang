			...
			<div class="row ">
				...
				<div class="col-xs-10">
					...
					<div style="height: 350px; width: 100%; background-color: #F5F5F5">
						<form action="${ctx }/area.do?action=modify" method="post"
							style="padding: 5% 20%">
							<input type="hidden" name="goods_id" value="${getarea.goods_id }" />
							商品名称：<input type="text" name="goods_name" value="${getarea.goods_name }"/>
							<br>
							...
							<a href="${ctx }/area.do?action=getall"><button type="button" class="btn btn-primary btn-sm">返回列表</button></a>
						</form>
					</div>
